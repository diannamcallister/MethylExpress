...
the second column is the count value for the gene's expression. An example
of a type of dataframe that could be used for this function can be found 
within the MethylExpress package, called *BeforeBariatricSurgery*:

``` {r}
MethylExpress::BeforeBariatricSurgery
```
