...
a, t, c, g). An example of the type of dataframe that could be used for this 
...
```{r}
MethylExpress::countCpGIslands(PossibleCpGIslands)
```

Now, the string from *PossibleCpGIslands* is outputted above, with the CpG
islands highlighted!
